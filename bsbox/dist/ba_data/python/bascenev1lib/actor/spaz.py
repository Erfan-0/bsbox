...
BASE_PUNCH_POWER_SCALE = 1.5
BASE_PUNCH_COOLDOWN = 500
...
class Spaz(bs.Actor):
    ...
    def __init__(
        ...
        powerups_expire: bool = True, # True -> False
        ...
        if isinstance(msg, bs.PickedUpMessage):
            ...
            if msg.hit_type == 'punch':
                ...
                if (
                    ...
                    if 250 < damage <= 500:
                        ...
                        radius = damage / 1000
                        dtype = 'normal' # tnt -> normal
                        chance_min = 4
                        aps = ['shield', 'block']
                    elif 1000 <= damage:
                        radius = damage / 5000
                        dtype = 'normal' # ice -> normal
                        chance_min = 3
                        aps = ['block']
            ...
            if msg.immediate:
                ...
                if not wasdead:
                    ...
                    if self.mode is bs.SmashActorMode:
                        if self.hitpercent > 1000: # 25 ro kardam 1000
                            blast_type = 'normal'
                            radius = min(self.hitpercent / 0, 0) # 5,20 ro kardam 0, 0
                        else:
                            blast_type = 'normal'
                            radius = 0
                        Blast(
